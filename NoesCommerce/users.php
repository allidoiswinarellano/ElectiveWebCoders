...
<body>
	...
	<div class="container-fluid">
		...
		<tbody>
				...
				echo "<td><a href=\"setuser.php?user_id=$row[user_id]\" class=\"btn btn-s btn-warning\"><span class=\"glyphicon glyphicon-edit\"></span></a> &nbsp &nbsp
					<a href=\"delete_user.php?user_id=$row[user_id]\" class=\"btn btn-s btn-danger\"><span class=\"glyphicon glyphicon-trash\"></span></a></td>";
		        echo "</tr>";
			}
