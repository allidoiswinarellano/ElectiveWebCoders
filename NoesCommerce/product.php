	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav navbar-right">
				<li><a href="add_product.php"><span class="glyphicon glyphicon-plus"></span> Add Product</a></li>
	...
	<div class="container-fluid">
		...
		<tbody>
		 			...
		 			while($row=mysqli_fetch_array($result_set))
		    		{
						...
						echo "<td><a href=\"edit_product.php?product_id=$row[product_id]\" class=\"btn btn-s btn-warning\"><span class=\"glyphicon glyphicon-edit\"></span></a> &nbsp &nbsp
							<a href=\"delete_product.php?product_id=$row[product_id]\" class=\"btn btn-s btn-danger\"><span class=\"glyphicon glyphicon-trash\"></span></a></td>";
				        echo "</tr>";
					}
