	...
	if(isset($_POST["addToProduct"])){
		...
		if($count > 0){
			...
			echo "
					<div class='alert alert-success'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>Sorry! You need to  Sign Up first before you can add products to your cart.</b>
					</div>
				";
		}
	...
	if($count > 0){
		...
		echo '
				...
				<form action="payment_success.php" method="post">
				  ...
				  <input type="hidden" name="business" value="shoppingcart@eshop.com">
				...
				<input type="submit" name="submit" class="btn btn-danger btn-lg" style="float:right;margin-right:80px;">
